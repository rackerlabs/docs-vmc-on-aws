...
htmlhelp_basename = 'docs-rpc-vmware'
...
latex_documents = [('index', 'docs-rpc-v.tex',
                    'RPC-VMware Customer Handbook',
                    'Rackspace', 'manual')]
...
man_pages = [
    ('index', 'docs-rpc-v',
     'RPC-VMware Customer Handbook', ['Rackspace'], 1)]
...
texinfo_documents = [('index', 'doc-rpc-v',
                      'RPC-VMware Customer Handbook',
                      'Rackspace', 'docs-rpc-v',
                      'Get 24x7x365 support for Rackspace Private Cloud powered by VMware',
                      'Miscellaneous')]
