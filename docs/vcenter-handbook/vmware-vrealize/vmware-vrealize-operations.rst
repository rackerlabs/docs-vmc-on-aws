...
.. this file is used in two other documents: vcloud-handbook and
   ...
   updating this file, you need to update this file in other locations as well.
...
.. _locating_ep_ops_agents-vcenter-book:
...
#. Locate the Linux (tar) EP Ops agent installation files (x32-bit or
   x64-bit) as described in :ref:`locating_ep_ops_agents-vcenter-book`.
