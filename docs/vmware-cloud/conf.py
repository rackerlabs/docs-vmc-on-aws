...
exclude_patterns = ['_build', 'samples', 'README.rst', 'common/common-vcloud*',
                    'common/common-vcenter-front.rst']
...
htmlhelp_basename = 'vmware-cloud'
...
latex_documents = [('index', 'docs-vmware-cloud.tex',
                    'Rackspace Managed VMware Cloud on AWS Customer Handbook',
                    'Rackspace', 'manual')]
...
man_pages = [
    ('index', 'docs-	• vmware-cloud',
     'Rackspace Managed VMware Cloud on AWS Customer Handbook', ['Rackspace'], 1)]
...
texinfo_documents = [('index', 'doc-rpc-v',
                      'Rackspace Managed VMware Cloud on AWS Customer Handbook',
                      'Rackspace', 'docs-vmware-cloud',
                      'Get 24x7x365 support for Rackspace Managed VMware Cloud on AWS',
                      'Miscellaneous')]
