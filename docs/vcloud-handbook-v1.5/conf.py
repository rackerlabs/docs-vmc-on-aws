# -*- coding: utf-8 -*-
"""
VMWare vCloud 1.5 documentation build configuration file.
...
exclude_patterns = ['_build', 'samples', 'README.rst', 'common/common-vcenter*',
                    'common/common-vcloud-front.rst']
...
htmlhelp_basename = 'docs-managed-vmware-vcloud-1.5'

# this will change the 'paragraph' character to '#'
html_add_permalinks = '#'

# -- Options for spell checker --------------------------------------------

spelling_word_list_filename = 'common/spelling_wordlist.txt'
