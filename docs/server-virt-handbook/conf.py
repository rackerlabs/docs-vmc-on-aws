...
latex_documents = [('index', 'docs-server-virt.tex',
                    'Server Virtualization Customer Handbook',
                    'Rackspace', 'manual')]
...
man_pages = [
    ('index', 'docs-server-virt',
     'Server Virtualization Customer Handbook', ['Rackspace'], 1)]
...
texinfo_documents = [('index', 'doc-rpc-v',
                      'Server Virtualization Customer Handbook',
                      'Rackspace', 'docs-server-virt',
                      'Get 24x7x365 support for Server Virtualization',
                      'Miscellaneous')]
